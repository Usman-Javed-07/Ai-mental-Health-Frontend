  ...
  return (
    ...
    <div className={styles.contactContainer}>
      ...
      <div className={styles.contactDetails}>
          ...
          <p><strong>Address:</strong>NFC Institute of Engineering and Technology</p>
        </div>
              {/* FAQs */}
      <div className={styles.faqSection}>
        ...
        <details>
          ...
          <p className={styles.summaryPara}>Our AI therapist is available 24/7. Simply start a chat and get assistance instantly.</p>
        </details>
        <details>
          <summary>Is my data secure?</summary>
          <p className={styles.summaryPara}>Yes! We use encryption to protect all user data.</p>
        </details>
      </div>
       {/* Location Map */}
       ...
       <div className={styles.socialMedia}>
        ...
        <div className={styles.socialIcons}>
          <a className={styles.fbIcon} href="#"><FaFacebook /></a>
          <a className={styles.twitIcon} href="#"><FaXTwitter /></a>
          <a className={styles.instaIcon} href="#"><FaInstagram /></a>
        </div>
      </div>
    </div>
    </div>
